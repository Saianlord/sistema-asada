        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-slate-200 p-8">
                <div class="mb-6 pb-6 border-b border-slate-100">
                    ...
                    <p class="text-sm text-slate-500 mt-1">Modifique su evaluación utilizando una escala de 1 a 10.</p>
                </div>

                <form method="POST" action="{{ route('evaluations.update', [$project, $evaluation]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-text-input id="technical_score" name="technical_score" type="number" min="1" max="10" step="1" class="block w-full" :value="old('technical_score', $evaluation->technical_score)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="financial_score" name="financial_score" type="number" min="1" max="10" step="1" class="block w-full" :value="old('financial_score', $evaluation->financial_score)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="operational_score" name="operational_score" type="number" min="1" max="10" step="1" class="block w-full" :value="old('operational_score', $evaluation->operational_score)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="regulatory_score" name="regulatory_score" type="number" min="1" max="10" step="1" class="block w-full" :value="old('regulatory_score', $evaluation->regulatory_score)" required />
